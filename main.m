...
Vdot0 = 9581/3600/100; % units of m^3/s

%Coolant Properties
U = 0.3; % units of kJ/(m^2*K*s)
Tc0 =430; % units of K, boiling point is 530 K
...
G = rho0*(Vdot0/Ac); % units of kg/(m^2 * s)
...
handleranon = @(v,y) handler(v,y,phi,H_tot,Cp_tot,L,D,Beta,Dp,Ac,N,U,flowC,Ftotal_0,T0,P0,rho0,dv); % use handler fxn
